...
namespace SimpleFileExplorer.Classes
{
    ...
    /// <summary>
    /// A clasee to retreive the system icons
    /// </summary>
    public class Icons
    {
        ...
        public static Icon GetIcon(string path, bool isDirectory)
        {
            ...
            hImgLarge = SHGetFileInfo(path, attributes, out shfi, (uint)Marshal.SizeOf(typeof(SHFILEINFO)), SHGFI_ICON | SHGFI_LARGEICON);
